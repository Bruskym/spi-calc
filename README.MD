...
- **Shapefile (.shp)**: Deve estar localizado no diretório `data_shapefile/`. O script automaticamente usa o primeiro `.shp` encontrado para fazer o recorte da área onde o SPI será calculado.
